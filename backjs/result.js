...
function handleCheckboxChange() {
    // Thực hiện các công việc cần thiết khi checkbox thay đổi trạng thái
    if (document.getElementById('nav-mobile-input').checked) {
        var element = document.querySelector('.nav-mobile');
        element.style.transform = 'translateX(0%)';
           
        var element1 = document.querySelector('.cointainer');
